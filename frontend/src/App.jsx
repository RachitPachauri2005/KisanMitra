...
import logo from './assets/KisanMitra.png'
      ...
      <nav className="bg-white shadow-lg sticky top-0 z-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4 space-x-2">
              <img src={logo} alt="KisanMitra logo" draggable='false' className="h-12 w-50" />
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="text-2xl font-bold mb-4">🌱 KisanMitra</div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            © 2025 KisanMitra. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
